...
export default function OfferComponent() {
    ...
    const totalPages = Math.ceil(OfferState?.length / itemsPerPage);
    ...
    const displayedData = offer.slice(
        (page - 1) * itemsPerPage,
        page * itemsPerPage
    );

    console.log("Ali====>dat", offer)
        ...
        <div className="card card-cascade narrower">
            ...
            <div className="container mt-3">
                ...
                <div style={{ display: "flex", justifyContent: "center", alignItems: "center" }}>
                    <OfferPagination count={totalPages} page={page} onChange={handlePageChange} data={offer} />
                </div>
            </div>
