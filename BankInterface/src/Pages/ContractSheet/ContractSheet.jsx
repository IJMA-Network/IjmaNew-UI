...
//     if (savedContent) {
//       const editorState = EditorState.createWithContent(convertFromRaw(savedContent));
...
//   const handleOpen = () => {
//     // No need to update editorState here since it's already being set in useEffect
//   };
